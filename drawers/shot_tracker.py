...
class ShotTracker:
                    ...
                    if pending_shot:
                        ...
                        for rim_track in rim_dict.values():
                            ...
                            if center[1] > rim_center[1]:
                                ...
                                outcome = self.check_shot_outcome(frame_num, latest_ball_point, center, rim_tracks,ball_tracks,shot_zone_box)
    ...
    def check_shot_outcome(self, frame_num, latest_ball_point, ball_point_below_rim, rim_track, ball_tracks, shot_zone_box):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            if frame_num < first_shot_frame:
                ...
                if frame_num == self.shots[total_shots]["frame"]:
                    outcome = self.shots[total_shots].get("outcome", "miss")
